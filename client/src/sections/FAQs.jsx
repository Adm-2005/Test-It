...
export default function FAQs() {
    ...
    return (
        <section id='faqs' className='w-full flex flex-col gap-[30px] p-3 justify-center items-center py-[40px]'>
            <div className='flex flex-col gap-2'>
                <h1 className='font-josefin font-bold text-center text-purple-950 text-4xl md:text-5xl'>
                    FAQs
                </h1>
                <p className='text-center text-slate-500 font-poppins italic'>Your questions about us, answered.</p>
            </div>
