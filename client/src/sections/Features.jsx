...
import { featureGroups } from "../utils/textConstants";
        ...
        >
            <div className="flex flex-col gap-2">
                ...
                <p className="text-center text-slate-500 font-poppins italic">
                    Discover what makes Test-It! your go-to testing tool.
                </p>
            </div>
            ...
            >
                {featureGroups.map((group, index) => (
                    <div
                        key={index}
                        className="flex justify-center items-center shadow-md border border-slate-100 rounded-sm p-4 h-full"
                    >
                        <div className="w-full h-full flex flex-col justify-center">
                            <h3 className="font-josefin font-bold text-xl text-purple-950">
                                {group.name}
                            </h3>
                            <p className="font-poppins font-medium text-slate-600">
                                {group.text}
                            </p>
                        </div>
                    </div>
