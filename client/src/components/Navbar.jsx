            ...
            >
                ...
                <div className="flex items-center">
                    <ul
                        className={
                            nav
                                ? "flex flex-col lg:flex-row gap-6 absolute lg:static top-[60px] left-0 right-0 bg-white lg:bg-transparent p-4"
                                : "hidden lg:flex gap-6 items-center justify-center"
                        }
                    >
                        {navLinks.map((navLink, index) => (
                            <li
                                key={index}
                                className="text-black hover:text-purple-400 lg:text-white text-md lg:text-lg font-semibold border-b lg:border-0"
                            >
